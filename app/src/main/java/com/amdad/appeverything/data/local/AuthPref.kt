package com.amdad.appeverything.data.local
...
import com.amdad.appeverything.util.getObject
import com.amdad.appeverything.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser>{
       val user = authUser
        if (user == null) {
            return ActionState(message = "Anda beluum terdaftar", isSuccess = false)
